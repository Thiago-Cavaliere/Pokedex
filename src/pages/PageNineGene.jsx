...
import { getNineGenerationPokemons } from "../services/api9";
...
function NineGene() {
  ...
  useEffect(() => {
    const fetchPokemons = async () => {
      const data = await getNineGenerationPokemons();
  ...
  return (
    <section className="container">
      {/* <h1 className="first__title">Nona Geração</h1> */}
