...
import { getFiveGenerationPokemons } from "../services/api5";
...
function FiveGene() {
  ...
  useEffect(() => {
    const fetchPokemons = async () => {
      const data = await getFiveGenerationPokemons();
  ...
  return (
    <section className="container">
      {/* <h1 className="first__title">Quinta Geração</h1> */}
