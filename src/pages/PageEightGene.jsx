...
import { getEightGenerationPokemons } from "../services/api8";
...
function EightGene() {
  ...
  useEffect(() => {
    const fetchPokemons = async () => {
      const data = await getEightGenerationPokemons();
  ...
  return (
    <section className="container">
      {/* <h1 className="first__title">Oitava Geração</h1> */}
