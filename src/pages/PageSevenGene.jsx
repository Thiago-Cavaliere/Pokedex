...
import { getSevenGenerationPokemons } from "../services/api7";
...
function SevenGene() {
  ...
  useEffect(() => {
    const fetchPokemons = async () => {
      const data = await getSevenGenerationPokemons();
  ...
  return (
    <section className="container">
      {/* <h1 className="first__title">Sétima Geração</h1> */}
